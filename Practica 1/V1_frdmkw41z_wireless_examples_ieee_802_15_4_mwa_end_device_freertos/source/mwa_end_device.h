...
#define mMacExtendedAddress_c      (0x4444444444440001)
...
#else
  #define mDefaultValueOfChannel_c (0x04000000) // To force the channel to 26 (1 << 26)
#endif
...
#define gAppEvt_SW3_Pressed_c   (1 << 5)  // Event flag triggered when switch 3 is pressed
#define gAppEvt_SW4_Pressed_c   (1 << 6)  // Event flag triggered when switch 4 is pressed
